...
# counties population percentage of the district
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        if (votes > largest_county_population) and (county_vote_percentage > largest_county_percentage):
            largest_county_population = votes
